...
SELECT Drug89.dbo.Bimeh.Bimeh,    -- Title - nvarchar(500)
       DimDB.Id,                  -- DBId - int
       Drug89.dbo.Bimeh.BimehCode -- OldId - int
FROM Drug89.dbo.Bimeh
    CROSS JOIN dbo.DimDB
WHERE dbo.DimDB.[Name] = N'Drug89';
...
FROM Drug89.dbo.Kala
    ...
    CROSS JOIN dbo.DimDB AS DDBDrug85
    INNER JOIN dbo.DimProductGroup AS DPG2
        ON DPG2.DBId = DDBDrug85.Id
           AND DPG2.OldId = 0
WHERE dbo.DimDB.[Name] = N'Drug89'
      AND DDBDrug85.[Name] = N'Drug85';
